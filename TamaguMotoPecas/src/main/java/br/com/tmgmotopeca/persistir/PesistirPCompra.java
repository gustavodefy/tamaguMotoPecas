...
public class PesistirPCompra implements Persistir{
    ...
    public void buscar(int id) throws Exception {
        try {
            ...
            List listheader = DaoHeader.getLista(whereId);
            
            for (Object h : listheader) {
                pedidoCompra.setPCHeader((PCHeader)h);
                ...
                whereId2.add(rangeId);
                List lista2 = DaoItem.getLista(whereId);
                pedidoCompra.setArrayPCItem((ArrayList<PCItem>)lista2);
            }
    ...
    public Iterator buscarLista(ArrayList<Range> rangeCondicao) throws Exception {
        try {
            ...
            List lista = DaoHeader.getLista(rangeCondicao);
            for (Object h : lista) {
                pedidoCompra.setPCHeader((PCHeader)h);
                List lista2 = DaoItem.getLista(rangeCondicao);
                pedidoCompra.setArrayPCItem((ArrayList<PCItem>)lista2);
